                    ...
                    <section class="p-content p-group u-gap--sub u-padding--left u-display__column">
                        <a href="single.html">
                            <figure class=" u-display__flex c-background-color__brown u-display__column">
                                <img src="/img/food-search.jpg" class="c-img__item" alt="チーズバーガー"></img>
                                <figcaption class="p-content__inner">
                                    <h3 class="p-content__inner--top c-text--top">チーズバーガー</h3>
                        ...
                        <a href="single.html">
                            <figure class="p-content u-display__flex c-background-color__brown u-display__column">
                                <img src="/img/food-search.jpg" class="c-img__item" alt="ダブルチーズバーガー"></img>
                                <figcaption class="p-content__inner">
                                    <h3 class="p-content__inner--top c-text--top">ダブルチーズバーガー</h3>
                                    <span class="p-content__inner--small c-text--medium">小見出しが入ります</span>
                                    <p class="p-content__inner--medium c-text--small">
                                        テキストが入ります。テキストが入ります。テキストが入ります。テキストが入ります。
                                        テキストが入ります。テキストが入ります。テキストが入ります。テキストが入ります。
                                        テキストが入ります。テキストが入ります。テキストが入ります。テキストが入ります。
                        ...
                        <a href="single.html">
                            <figure class="p-content u-display__flex c-background-color__brown u-display__column">
                                <img src="/img/food-search.jpg" class="c-img__item" alt="スペシャルバーガー"></img>
                                <figcaption class="p-content__inner">
                                    <h3 class="p-content__inner--top c-text--top">スペシャルバーガー</h3>
                                    <span class="p-content__inner--small c-text--medium">小見出しが入ります</span>
                                    <p class="p-content__inner--medium c-text--small">
                                        テキストが入ります。テキストが入ります。テキストが入ります。テキストが入ります。
                                        テキストが入ります。テキストが入ります。テキストが入ります。テキストが入ります。
                    ...
                    while( have_post())://表示する投稿データがあれば繰り返し処理開始
                        ...
                        <div id = "post-<?php the_ID(); ?>" <?php post_class(); ?>>
                            <a href="<?php the_permalink(); ?>">
                                <figure class=" u-display__flex c-background-color__brown u-display__column">
                                    <img src="<?php the_post_thumbnail(); ?>" class="c-img__item" alt=""></img>
                                    <figcaption class="p-content__inner">
                                        <h3 class="p-content__inner--top c-text--top"><?php get_the_title(); ?></h3>
                                        <span class="p-content__inner--small c-text--medium u-text__bold">小見出しが入ります</span>
                                        <p class="p-content__inner--medium c-text--small">
                                        テキストが入ります。テキストが入ります。テキストが入ります。テキストが入ります。
                                        テキストが入ります。テキストが入ります。テキストが入ります。テキストが入ります。
